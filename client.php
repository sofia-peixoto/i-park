...
function insertNewPark(){
	...
	$park = Array('ID' => '', "Name" => "Parque 2", "Company" => "Empresa BlaBla", "Address" => "Rua sem saida", "ZIPCode" => "1234-123", "ZIPLocation" => "Cidade", "Country" => "Portugal", "Latitude" => "", "Longitude" => "", "Phone" => "123123123", "OpeningHour" => "10:00", "ClosingHour" => "21:00", "PricePerHour" => 1, "Floors" => 1, "DisabledPlaces" => 8, "Capacity" => 130, 'Active' => 1, 'CreationDate' => '');
